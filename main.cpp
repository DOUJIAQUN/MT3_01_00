...
Matrix4x4 MakerViewportMatrix(float left, float top, float width, float height, float minDepth, float maxDepth) {
    Matrix4x4 result;
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 viewportMatrix = MakerViewportMatrix(100.0f, 200.0f, 600.0f, 300.0f, 0.0f, 1.0f);
		///
		/// ↑更新処理ここまで
		///
